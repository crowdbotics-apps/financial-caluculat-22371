"""financial_caluculat_22371 URL Configuration
...
admin.site.site_header = "Financial Caluculators"
admin.site.site_title = "Financial Caluculators Admin Portal"
admin.site.index_title = "Financial Caluculators Admin"

# swagger
api_info = openapi.Info(
    title="Financial Caluculators API",
    default_version="v1",
    description="API documentation for Financial Caluculators App",
)
